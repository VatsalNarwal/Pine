...
function openIssuesPage() {
  ipcRenderer.send("tabManager-addTab", "https://github.com/5R33CH4/Pine/issues", true);
}

function openDonatePage() {
  ipcRenderer.send("tabManager-addTab", "https://www.patreon.com/5R33CH4", false);
}

function openDeveloperPage() {
  ipcRenderer.send("tabManager-addTab", "https://5r33ch4.github.io/", true);
}

function openAppPage() {
  ipcRenderer.send("tabManager-addTab", "https://github.com/5r33ch4/", true);
}

function openReleasesPage() {
  ipcRenderer.send("tabManager-addTab", "https://github.com/5R33CH4/Pine/releases", true);
}
...
function openSourcePage() {
  ipcRenderer.send("tabManager-addTab", "https://github.com/5R33CH4/Pine", true);
}
...
function openLicensePage() {
  ipcRenderer.send("tabManager-addTab", "https://github.com/5R33CH4/Pine/blob/master/LICENSE", true);
}
