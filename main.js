...
const os = require("os");
const fs = require("fs");
const ppath = require("persist-path")("Pine");
  ...
  let constructor = [{
    ...
    label: "Help", icon: app.getAppPath() + "/imgs/icons16/help.png", submenu: [{ 
      ...
      label: "Report an issue", icon: app.getAppPath() + "/imgs/icons16/bug-report.png", accelerator: "CmdOrCtrl+Shift+I", click: () => { 
        tabManager.addTab("https://github.com/5R33CH4/Pine/issues", true);
      } }
    ] }, { 
    ...
    label: "Quit Pine", icon: app.getAppPath() + "/imgs/icons16/exit.png", accelerator: "CmdOrCtrl+Shift+Q", click: () => { 
      app.quit(); 
    } }
  ];
